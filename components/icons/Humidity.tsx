...
function Humidity({ width, height, className, color, props }: Props) {
	return (
		<Svg
			className={className}
			height={height}
		...
		>
			...
			<Path
				fill={color}
				d='M208 192c-26.464 0-48 21.536-48 48s21.536 48 48 48 48-21.536 48-48-21.536-48-48-48zm0 64c-8.832 0-16-7.168-16-16s7.168-16 16-16 16 7.168 16 16-7.168 16-16 16zm96 96c-26.464 0-48 21.536-48 48s21.536 48 48 48 48-21.536 48-48-21.536-48-48-48zm0 64c-8.8 0-16-7.2-16-16s7.2-16 16-16 16 7.2 16 16-7.2 16-16 16zm43.296-187.296c-6.24-6.24-16.384-6.24-22.624 0l-160 160c-6.24 6.24-6.24 16.384 0 22.624C167.808 414.432 171.904 416 176 416s8.192-1.568 11.296-4.672l160-160c6.24-6.24 6.24-16.384 0-22.624z'
				data-original='#000000'
			/>
		</Svg>
	)
